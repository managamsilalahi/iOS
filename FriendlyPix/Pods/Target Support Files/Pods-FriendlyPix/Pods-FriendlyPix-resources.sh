...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "STXDynamicTableView/STXDynamicTableView/Cells/STXFeedPhotoCell.xib"
  install_resource "STXDynamicTableView/STXDynamicTableView/Cells/STXUserActionCell.xib"
  install_resource "STXDynamicTableView/STXDynamicTableView/Images.xcassets"
fi
